...
layout = dbc.Container([
    dbc.Row([
        ...
        html.Br(),
        html.Hr(),
        html.Center(html.H5(children='* Only trading days data available from (Mon - Fri) days date. (Trading day data will be uploaded at 06:30 PM) Please select trading day date...'),style={"color": "red"}),
        # dbc.Col([
        ...
        dbc.Col([
            ...
            html.Br(), 
            html.Center(html.H5(children='Please Select (Mon - Fri) days date... (Only Trading Day)') ,style={"color": "blue"}),
        ])
    ])
])
